...
# stub_routes.py/note_service.py открывали httpx.AsyncClient(...) заново на каждый вызов
# (новое TCP-соединение на каждый запрос вместо переиспользуемого пула). Закрываются в
# main.py::lifespan при остановке приложения.
