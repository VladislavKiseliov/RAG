...
class UsersStorageService:
    """S3-хранилище, привязанное к бакету пользовательских файлов.

    Просто хранение и получение файлов (аватары и т.п.), без доп. логики.
    """

    def __init__(self, store: S3StorageRepository) -> None:
        self._store = store
        self._bucket = settings.minio_buckets[StorageDomain.USERS]
